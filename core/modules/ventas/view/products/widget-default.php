...
<!--<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <li><a href="Existencia.php">PDF</a></li>
  </ul>-->
</div>
...
?>
<br><br><br><br><br>
<button class="btn btn-info" onclick="window.open('Reporte-inventario.php')"> GENERAR REPORTE</button>
