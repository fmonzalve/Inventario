...
$q= OperationData::getQYesF($product->id);
	...
	<tr class="<?php if($q<=$product->inventary_min){ echo "danger"; }?>">
        ...
        <td><input type="number" class="form-control" required name="precio" placeholder="Precio de producto ..." min="0"></td>
	...
	<?php
}else{echo "<div class='col-md-12'><br><p><b>No se han encontrado productos</p></b></div>";}
?>
<br><hr>
<hr><br>
<?php else:
