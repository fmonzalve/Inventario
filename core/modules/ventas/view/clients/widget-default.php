...
<div class="btn-group pull-right">
        <a href="index.php?view=newclient" class="btn btn-default"><i class='fa fa-smile-o'></i> Nuevo Funcionario</a>
    <!--<div class="btn-group pull-right">
...
<br>
		...
		if(count($users)>0){
			...
			echo "<p class='alert alert-danger'>No hay funcionarios</p>";
		}
