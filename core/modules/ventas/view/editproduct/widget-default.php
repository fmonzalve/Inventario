...
<?php// endif;?>
  ...
  -->
    ...
    <div class="col-md-8">
      <input type="text" name="barcode" class="form-control" id="barcode" value="<?php echo $product->barcode; ?>" placeholder="Código de Barra">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="number" name="price_in" class="form-control" value="<?php echo $product->price_in; ?>" id="price_in" placeholder="Precio de entrada" min="0">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="number" name="inventary_min" class="form-control" value="<?php echo $product->inventary_min;?>" id="inputEmail1" placeholder="Mínima en Inventario (Default 10)" min="1">
    </div>
  </div>
