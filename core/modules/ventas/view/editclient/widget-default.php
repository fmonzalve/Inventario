...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="address2" value="<?php echo $user->address2;?>" class="form-control" required id="username" placeholder="Unidad">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="phone1"  value="<?php echo $user->phone1;?>"  class="form-control" id="inputEmail1" placeholder="Rut">
    </div>
  </div>
