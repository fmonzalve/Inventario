...
<!--
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
            <select name="tipo">
                <option value="Activo Variable">Activo Variable</option>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Barcode*</label>
    <div class="col-md-6">
      <input type="text" name="barcode" required class="form-control" id="barcode" placeholder="Codigo de Barra">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="number" name="q" class="form-control" id="inputEmail1" placeholder="Inventario inicial" min="1" required>
    </div>
  </div>
