...
class SellData {
	...
	public static function getAllByPage($start_from,$limit){
    	...
    	public static function getSellsByCli($code){
		$sql = "select sell.person_id, operation.product_id,operation.q,sell.created_at from sell,operation where  sell.operation_type_id=2 and operation.sell_id=sell.id and person_id=$code";
		$query = Executor::doit($sql);
		$array = array();
		$cnt = 0;
		while($r = $query[0]->fetch_array()){
